...
function createConfig(env = {}) {
  ...
  const projectColumnNumber = env.PROJECT_COLUMN_NUMBER;
  const projectTestingColumnNumber = env.PROJECT_TESTING_COLUMN_NUMBER;
  const skipLabelCheck = env.SKIP_LABEL_CHECK || false;
